...
export default class Leaderboard extends cc.Component {
    ...
    start() {
        ...
        // canvas.width = this.friendLeaderBoardSprite.node.width;
        // canvas.height = this.friendLeaderBoardSprite.node.height;
